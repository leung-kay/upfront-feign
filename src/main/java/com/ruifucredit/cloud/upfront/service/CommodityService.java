...
import com.ruifucredit.cloud.upfront.repository.http.IGoodsClient;
import com.ruifucredit.cloud.upfront.repository.http.IStockClient;
...
public class CommodityService implements ICommodityService {
	...
	public Commodity query(@NonNull Long goodsId) {
		...
		Outcoming<Goods> goodsOutcoming = goodsClient.queryGoods(goodsId);

		if (goodsOutcoming.getCode() == Outcoming.OK_CODE) {

			Outcoming<List<Stock>> stocksOutcoming = stockClient.queryCommodityStock(goodsId);
